...
class PriceSohu(PriceSuper):
    ...
    def parsePrice(self,en_msg):
        try:
            ...
            print('PriceSohu/parsePrice: %s' % e)
            return False
    ...
    def parsePrice(self,en_msg):
        try:
            ...
            if real_pri != -1:
                ...
                print("PriceTenc fail,org price: %s" % en_msg)
                return False

            return self.real_price

        except Exception, e:
            print('PriceTenc/parsePrice: %s'%e)
            return False
...
class PriceGyi(PriceSuper):
    ...
    def parsePrice(self, en_msg):
        try:
            ...
            print('GyinLogShowHandler/parsePrice: %s'%e)
            return False
...
class PriceAllyes(PriceSuper):
    ...
    def parsePrice(self, en_msg):
        try:
            ...
            print('PriceAllyes/parsePrice: %s ,price:%s'%(e, en_msg))
            return False
    ...
    def parsePrice(self, en_msg):
        try:
            ...
            if real_pri != -1:
                ...
                print("PriceAmax fail,org price: %s" % en_msg)
                return False

            return self.real_price

        except Exception, e:
            print('PriceAmax/parsePrice: %s'%e)
            return False
...
class PriceYouku(PriceSuper):
    ...
    def parsePrice(self, en_msg):
        try:
            ...
            print('PriceYouku/parsePrice: %s %s'% (e, en_msg))
            return False
...
class PriceWeibo():
    ...
    def parsePrice(self,en_msg):
        try:
            ...
            print('WeiBo parsePrice Err:%s ' % e)
            return 0
