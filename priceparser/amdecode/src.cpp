...
int TestWinningPrice(const string& kB64EncodedValue) {
  const char kEncryptionKey[] = {
      0x93, 0x2E, 0x43, 0x51, 0xBF, 0xC1, 0xEA, 0x6A, 0x2C, 0x6F, 0xB4, 0xA3,
      0xD0, 0xEB, 0xD7, 0x4E, 0x2F, 0xDD, 0xB3, 0xA9, 0x6F, 0x2B, 0x59, 0x68,
      0x41, 0x58, 0xA3, 0xD7, 0x12, 0xEC, 0x19, 0x32
  };
  const char kIntegrityKey[] = {
      0xE1, 0x4E, 0x56, 0x67, 0x8E, 0x23, 0x2A, 0x5A, 0x6E, 0x6D, 0xD8, 0xFC,
      0x3F, 0x19, 0x3C, 0xBE, 0x7A, 0x8D, 0x16, 0xED, 0x54, 0xEC, 0xC9, 0x3E,
      0x3F, 0x1E, 0xD2, 0x2A, 0x3A, 0xC5, 0xF3, 0xF1
  };
  ...
  //const string kB64EncodedValue("U0eHHQA1YFZTR4cdADVgVor8yHXuGEEcTMjEzQ");
...
int main(int argc, char** argv) {
  int status = TestWinningPrice("U0eHHQA1YFZTR4cdADVgVor8yHXuGEEcTMjEzQ");
  if (status != 0) {
    return status;
  }
