...
const char integrity_key_v[]  = {
	0x48,0xd8,0x6c,0xe0,0x75,0x02,0x83,0x13,0x19,0xeb,0x35,0x16,0x0d,0xa6,0x58,0x9d,0xcd,0xd5,0xe1,0x46,0x58,0x55,0xea,0x5f,0x1a,0x80,0x2a,0x43,0x4a,0x6d,0xc7,0xcd
};*/
const char integrity_key_v[]  = {
0xd1,0xc9,0x9d,0xd7,0x23,0x81,0x2b,0x36,0x2b,0x33,0x92,0x8c,0xe7,0x6f,0xa3,0xbf,0x6f,0x3f,0xde,0xa1,0xbf,0xe5,0xfb,0x9d,0x62,0x5d,0xda,0x08,0x4f,0x7a,0x6b,0x54
};
// 加密密钥
/*
const char encryption_key_v[] = {
	0xfd,0x45,0xd3,0xe4,0xee,0xc9,0x2d,0xe4,0xdf,0xc4,0xe6,0xa3,0x85,0x9d,0xf1,0x87,0x5a,0x12,0x13,0x84,0x49,0x9c,0x73,0x7f,0x5f,0x0f,0x15,0x7e,0xee,0x7c,0x99,0x9d
};*/
const char encryption_key_v[] = {
0xc7,0x12,0x50,0x4d,0x7e,0xc4,0xe0,0x5c,0x2b,0xc3,0x3b,0xa0,0x1c,0x1d,0x3a,0x38,0x4b,0xfd,0xf9,0xac,0x27,0x46,0xd8,0x36,0x3e,0x3c,0xb9,0x86,0xe1,0x14,0xa3,0x2e
};
...
int gydecode(const std::string& encryption_value)
{
    ...
    {
        cout << "guang gao jia[GY] decryption failed";
        return 0;
    }
    return act_value;
}
...
{
    std::string encryption_value = "RZD7LSw2Qlkg2NzdiU9KmtVgQrbVVZX7_Ehf3w";
    std::string padded = add_padding(encryption_value);
    std::string decode_value;
    int64_t act_value = 0 ;
    web_safe_base64_decode(padded,&decode_value);
    cout << endl << "encoded string:" << decode_value << endl;
    if (!decrypt_int64(decode_value,ENCRYPTION_KEY,INTEGRITY_KEY,&act_value))
    {
